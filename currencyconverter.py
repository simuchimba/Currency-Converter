...
class CurrencyConverter:  
    def __init__(self):  
        window = Tk()  
        window.title("Kuunda Simuchimba's Currency Converter")  
        window.configure(bg="blue")   

        
        Label(window,font="Helvetica 12 bold",bg="blue",text ="Enter The Amount to convert").grid(row=1, column=1,sticky =W)
        Label(window,font="Helvetica 12 bold",bg="blue",text ="Enter the Conversion Rate").grid(row=2, column=1,sticky =W)
        Label(window,font="Helvetica 12 bold",bg="blue",text ="Your converted amount is: ").grid(row=3, column=1,sticky =W)
